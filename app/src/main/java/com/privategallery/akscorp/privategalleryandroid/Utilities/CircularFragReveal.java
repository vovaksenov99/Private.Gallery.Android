...
/**
 * Modified by AksCorp on 07.04.2018.
 * akscorp2014@gmail.com
 * web site aksenov-vladimir.herokuapp.com
 * <p>
 * Fix
 * 1. Weakreference null pointer
 * 2. Null conditions
 */
...
public class CircularFragReveal {
    ...
    private View.OnTouchListener mRootTouchListener = new View.OnTouchListener() {
        ...
        public boolean onTouch(View v, MotionEvent event) {
            ...
            startUnreveal((int) event.getX(), (int) event.getY(), (OnCircularReveal) mCallback);
            return true;
        }
    };
    ...
    private Animator.AnimatorListener mUnRevealAnimListener = new Animator.AnimatorListener() {
        ...
        public void onAnimationStart(Animator animation) {
            ...
            ((OnCircularReveal) mCallback).onFragCircUnRevealStart();
            onTouchUnRevealOff();
        }
        ...
        public void onAnimationEnd(Animator animation) {
            ...
            if (mCallback == null)
                return;
            ((OnCircularReveal) mCallback).onFragCircUnRevealEnded();
        }
    ...
    private Animator.AnimatorListener mRevealAnimListener = new Animator.AnimatorListener() {
        ...
        public void onAnimationStart(Animator animation) {
            ...
            ((OnCircularReveal) mCallback).onFragCircRevealStart();
        }
        ...
        public void onAnimationEnd(Animator animation) {
            ...
            ((OnCircularReveal) mCallback).onFragCircRevealEnded();
